...
class BusRouteAcctoThrghSttn {
  ...
  @override
  String toString() =>
      'BusRouteAcctoThrghSttn(routeId: $routeId, nodeId: $nodeId, nodeNm: $nodeNm, nodeNo: $nodeNo, nodeOrd: $nodeOrd, gpsLati: $gpsLati, gpsLong: $gpsLong, upDownCd: $upDownCd)';
}
